<?php
// HTTP
define('HTTP_SERVER', 'http://sannhaonline.local/admin/');
define('HTTP_CATALOG', 'http://sannhaonline.local/');

// HTTPS
define('HTTPS_SERVER', 'http://sannhaonline.local/admin/');
...
define('DB_PASSWORD', '');
define('DB_DATABASE', 'sannhaonline');
define('DB_PORT', '3306');
