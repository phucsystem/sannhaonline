        ...
        if ($product_info) {
            ...
            foreach ($categories as $key => $category) {
                ...
                if ($results) {
                    foreach ($results as $result) {
                        if ($result['image']) {
                            $image = $this->model_tool_image->resize($result['image'], 80, 69);
                        } else {
                            $image = $this->model_tool_image->resize('placeholder.png', 80, 69);
                        }
                ...
                $other_products = array_merge($other_products, $products);
            }
            $other_products = array_slice($other_products, 0, 5);
